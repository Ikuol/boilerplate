...
const Hero = () => {
  return (
    <section className={`${styles.xPaddings} py-24 relative`}>
        <div className={`container mx-auto flex max-lg:flex-col justify-between items-center gap-8`}>
            <div className={`flex-[1.2] flex gap-2 relative flex-col`}>
                <p className="font-semibold text-white text-[80px] z-10">
                  Seamless <br/>Communication<br/>with OmniGPT
                </p>
                <img
                  src="/ellipse.png"
                  alt="ellipse"
                ...
                <p className="text-white text-[20px]">
                  ...
                  Our chat platform provides seamless communication<br />
            ...
            <div className={`${styles.flexCenter} gap-12 flex-col`}>
              <div className="flex gap-8 relative">
                <div className="bg-yellow w-[300px] h-[100px]
                rounded-l-full rounded-br-full" />
                <div className="bg-pink w-[100px] h-[100px]
                rounded-full" />
                <img
                  src="/fauxels.png"
                  alt="people"
              ...
              <div className="flex gap-8 relative">
                ...
                />
                <div className="bg-white w-[300px] h-[100px]
                rounded-l-full rounded-r-full" />
              </div>
              <div className="flex gap-8">
                <div className="bg-pink w-[425px] h-[100px]
                rounded-tl-full rounded-r-full text-end py-3 px-8">
                  <p className="text-white">
                  @OmniGPT Can you give us<br />
                  an update on the latest project<br />
                  status?</p>
                </div>
              </div>
              <div className="flex gap-8 relative">
                <div className="bg-green w-[300px] h-[100px]
                rounded-l-full rounded-br-full" />
                <img
                  src="/andrea.png"
                  alt="people"
